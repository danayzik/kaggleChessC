...
const std::array<const int*, 6> mg_pesto_table = {
        mg_pawn_table.data(),
...
const std::array<const int*, 6> eg_pesto_table = {
        eg_pawn_table.data(),
...
std::array<int, 12> gamephaseInc = {0, 0, 1, 1, 1, 1, 2, 2, 4, 4, 0, 0};
std::array<std::array<int, 64>, 12> mg_table;
std::array<std::array<int, 64>, 12> eg_table;

// Function definitions
constexpr int PCOLOR(int p) { return p & 1; }
